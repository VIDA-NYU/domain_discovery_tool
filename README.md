...
To run using the docker version download the scrip [run_docker_ddt](https://raw.githubusercontent.com/ViDA-NYU/domain_discovery_tool_react/master/bin/run_docker_ddt) and run it:
