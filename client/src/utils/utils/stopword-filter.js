const stopWordList = ["a","about","above","after","again","against","all","am",
...
function stopWordFilter(inputString) {
  return inputString.split(" ")
          .map(word => word.toLowerCase())
          .filter(word => stopWordList.indexOf(word) === -1)
          .join(",");
}

export { stopWordFilter };
